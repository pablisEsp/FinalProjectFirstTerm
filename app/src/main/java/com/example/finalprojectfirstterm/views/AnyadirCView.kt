...
@Composable
fun AnyadirCView(navController: NavController, viewModel: AViewModel){
    Scaffold(
        topBar = {
        ...
        ContentAgregarCView(it, navController, viewModel)
    }
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ContentAgregarCView(it: PaddingValues, navController: NavController, viewModel: AViewModel){
    val keyboardController = LocalSoftwareKeyboardController.current

    var nomP by remember { mutableStateOf("") }
    var telP by remember { mutableStateOf("") }
    var asuntoP by remember { mutableStateOf("") }
    ...
    var horaSeleccionada by remember { mutableStateOf(horasLista[0]) }
